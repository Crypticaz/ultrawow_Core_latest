...
public:
    ...
    static bool HandleAnticheatWarnCommand(ChatHandler* handler, const char* args)
    {
        ...
        char* buf = strdup("Prince AntiCheat Chandin Bar Gozaresh Dade Ast Ke Shoma Az Hack Estefade Mikonid, Shoma Bar Rasi Khahid Shod Ta Be Surate Kamel Moshakhas Shavad.");
        char* pos = buf;
