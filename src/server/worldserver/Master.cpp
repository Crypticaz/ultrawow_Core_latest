...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "WOW-EMU 4.3.4");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "www.wow-emu.org");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "All Rights Reserved");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "WOW EMU V1 4.3.4");
